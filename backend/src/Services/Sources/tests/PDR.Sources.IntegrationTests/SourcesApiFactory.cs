...
/// </summary>
public class SourcesApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    private readonly PostgreSqlContainer _database = new PostgreSqlBuilder("postgres:17-alpine")
        .WithDatabase("pdr_sources")
        .WithUsername("pdr")
        .WithPassword("pdr")
        .Build();
...
public sealed class SecuredSourcesApiFactory : SourcesApiFactory
{
