...
/// </summary>
public class AuditApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    private readonly PostgreSqlContainer _database = new PostgreSqlBuilder("postgres:17-alpine")
        .WithDatabase("pdr_audit")
        .WithUsername("pdr")
        .WithPassword("pdr")
        .Build();
...
public sealed class SecuredAuditApiFactory : AuditApiFactory
{
