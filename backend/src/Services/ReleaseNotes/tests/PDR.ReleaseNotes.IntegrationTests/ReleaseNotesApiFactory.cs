...
/// </summary>
public class ReleaseNotesApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    private readonly PostgreSqlContainer _database = new PostgreSqlBuilder("postgres:17-alpine")
        .WithDatabase("pdr_releasenotes")
        .WithUsername("pdr")
        .WithPassword("pdr")
        .Build();

    /// <summary>When true the service runs as a Keycloak resource server and rejects anonymous writes.</summary>
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        // UseSetting feeds the host configuration, which minimal hosting applies after appsettings.json.
...
public sealed class SecuredReleaseNotesApiFactory : ReleaseNotesApiFactory
{
